...
<head>
	...
	<!-- //Calendar -->
	<link href="backend/css/wickedpicker.css" rel="stylesheet" type='text/css' media="all" />
	<!-- Time-script-CSS -->
...
<body>
	...
	<div class="appointment-w3">
		...
		<div class="copy">
		<p>Back to Home<a href="index.php" target="_blank"> Click here</a></p>
	</div>
		</form>
	</div>
	...
	<!-- js -->
	<script type='text/javascript' src='backend/js/jquery-2.2.3.min.js'></script>
	<!-- //js -->
	<!-- Calendar -->
	...
	<!-- //Calendar -->
	<!-- Time -->
	<script type="text/javascript" src="backend/js/wickedpicker.js"></script>
